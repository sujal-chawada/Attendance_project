    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = r'C:\Users\ojass\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main/' + fileName
    ...
    def log_in():
        ...
        if username == 'ojas':
            if password == 'ojas123':
                ...
                cs = r'C:\Users\ojass\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
